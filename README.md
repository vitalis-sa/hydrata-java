...
2. API recebe e persiste em LEITURA_CLIMA / LEITURA_LUZ
       ↓
3. A cada nova mensagem MQTT o rule engine é executado (orientado a eventos)
       ↓
...
O motor de regras funciona orientado a eventos, sendo executado a cada nova mensagem MQTT recebida, cruzando três fontes de dados:
...
> **Nota:** O rule engine funciona orientado a eventos e **é acionado a cada nova mensagem MQTT** recebida. As leituras brutas são persistidas em `LEITURA_CLIMA` / `LEITURA_LUZ`, e o resultado do processamento em tempo real pode gerar um novo `ALERTA` caso os limites sejam ultrapassados.
...
| Swagger UI (Azure) | http://20.48.157.60:8080/swagger-ui/index.html#/ |
| Open-Meteo Docs | https://open-meteo.com/en/docs |
| ANA HidroWeb | https://www.snirh.gov.br/hidroweb |
| INPE BDQueimadas | https://queimadas.dgi.inpe.br/queimadas/bdqueimadas |
| Vídeo demonstração | [hydrata java demonstration](https://www.youtube.com/watch?v=DH2O7RAUWYY) |
| Vídeo pitch | [hydrata pitch](https://youtu.be/bpoYou45T6s) |
| Repositório GitHub | https://github.com/vitalis-sa/hydrata-java |
---
